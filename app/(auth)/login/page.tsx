...
function LoginForm() {
  ...
  const zohoEnabled = process.env.NEXT_PUBLIC_ZOHO_LOGIN === "1";
  const passwordEnabled = process.env.NEXT_PUBLIC_PASSWORD_LOGIN === "1";
...
export default function LoginPage() {
  // useSearchParams (for the callback's ?error=) makes this client-only, and
  // the build won't prerender that without something to fall back to.
  return (
    <Suspense
      fallback={
        <div className="flex items-center justify-center min-h-screen">
